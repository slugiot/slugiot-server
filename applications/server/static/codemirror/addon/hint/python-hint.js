(function () {
    ...
    var pythonKeywords = "procedureapi ProcedureApi api write_value write_output write_outputs write_log log_debug log_info log_warn log_error log_critical add_schedule remove_schedule add_schedule and del from not while as elif global or with assert else if pass yield break except import print class exec in raise continue finally is return def for lambda try";
